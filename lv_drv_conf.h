...
#if USE_FBDEV
#  define FBDEV_PATH          getenv("PITFT_DISPLAY")
#endif
...
#  define EVDEV_NAME   getenv("PITFT_TOUCHPANEL")        /*You can use the "evtest" Linux tool to get the list of devices and test them*/
